...
> Status: the OpenCode adapter is usable today. Codex integration is on the roadmap and is not advertised as complete.
...
- Presents OpenCode permission requests with **Allow once**, **Allow for session**, and **Reject** buttons.
...
Requirements: Windows 10/11, OpenCode Desktop, Node.js 20+, and a Telegram bot from [@BotFather](https://t.me/BotFather).
...
| `/approvals` | Show pending OpenCode permission requests |
