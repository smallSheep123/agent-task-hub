...
fakeWebSocket.emit("message", { data: JSON.stringify({ method: "turn/completed", params: { threadId: "guardian_1", turn: { id: "guardian_turn", status: "completed", items: [{ type: "agentMessage", text: "{\"outcome\":\"allow\"}" }] } } }) })
await new Promise((resolve) => setImmediate(resolve))
assert.equal(internalTerminalEvents, 0)
